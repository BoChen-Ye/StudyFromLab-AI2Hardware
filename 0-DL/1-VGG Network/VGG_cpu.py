...
from layers import FullyConnectedLayer, ReLULayer, SoftmaxLossLayer, ConvolutionalLayer, MaxPoolingLayer, FlattenLayer
...
class VGG19(object):
    ...
    def evaluate(self):
        ...
        label = label_map[top1] if top1 < len(label_map) else 'unknown'
        print('Classification result: id = %d, label = %s, prob = %f' % (top1, label, prob[0, top1]))
